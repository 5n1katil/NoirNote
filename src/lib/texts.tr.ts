...
export const textsTR = {
  ...
  cases: {
    ...
    case002: {
      ...
      clues: {
        clue1: "Kurban zehirli bir içecekle öldürüldü.",
        clue2: "Kurbanın yanında bir servis tepsisine rastlandı.",
        clue3: "Oda kilidi normal şekilde açılmış, zorlama izi yok.",
        clue4: "Güvenlik kamerası kayıtları, olay sırasında Mert'in kameralı koridorda olduğunu gösteriyor.",
        clue5: "Zehirli içeceğin tarifi, sadece etkinlik personeli tarafından hazırlanan VIP tarifine uyuyor.",
      },
    },
  },
  suspects: {
    ...
    bio007: "Oda Hizmetleri Sorumlusu. Anahtar kartı sadece hizmet alanlarını açar, misafir odalarını açmaz. İçecek hazırlama bilgisi yok.",
    bio008: "Güvenlik Görevlisi. Görev sırasında sürekli kamera kaydı olan koridorlarda bulunur. Misafir odalarına sınırlı erişimi var.",
    bio009: "Etkinlik Koordinatörü. VIP içecek servisi yapar, özel tarifler hazırlar. Tüm misafir odalarına tam erişim yetkisi var.",
  },
  locations: {
    ...
    desc007: "Misafir Odası. Kurbanın bulunduğu yer, içinde servis tepsisine rastlandı.",
    desc008: "Servis Koridoru. Personel geçiş alanı, kamera kayıtları var.",
    desc009: "Merdiven Boşluğu. Acil çıkış alanı, kamera kaydı yok.",
  },
  weapons: {
    ...
    desc007: "Kırık cam şişe parçası. Kullanıldığında cam kırıkları ve fiziksel izler bırakır.",
    desc008: "Metal levye. Kapıları zorlamak için kullanılır, kilit üzerinde mekanik hasar bırakır.",
    desc009: "Zehirli içecek. Özel tarifle hazırlanır, tüketildiğinde ölümcül etki yapar, fiziksel iz bırakmaz.",
  },
  grid: {
